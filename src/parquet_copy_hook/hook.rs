...
use crate::parquet_copy_hook::{
    ...
    copy_utils::{
        copy_stmt_batch_size_option, copy_stmt_filename, is_copy_from_parquet_stmt,
        is_copy_to_parquet_stmt,
    },
};

use super::{copy_from::execute_copy_from, copy_to::execute_copy_to_with_dest_receiver};
...
impl PgHooks for ParquetCopyHook {
    fn process_utility_hook(
        ...
        if is_copy_to_parquet_stmt(&pstmt) {
            ...
            let parquet_dest = create_copy_to_parquet_dest_receiver(filename, batch_size);
